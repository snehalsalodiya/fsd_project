    ...
    return(
      ...
      <section className="section-blog  py-10">
                         <form className="bg-white mt-8" >
                                        ...
                                        <input className="mt-4 mb-2 w-full cursor-pointer rounded-lg bg-cyan-700 pt-3 pb-3 text-white shadow-lg hover:bg-cyan-600" type="submit" value="Update account" />
                                    </form>
       </section>
    </>   )
}